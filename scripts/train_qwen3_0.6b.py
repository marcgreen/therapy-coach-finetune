...
GPU: A10G (24GB) - sufficient for 16k context with 0.6B model
...
# QLoRA config - scaled for 0.6B model
peft_config = LoraConfig(
    r=8,  # Reduced from 64 (14B) - appropriate for smaller model
    lora_alpha=16,  # Reduced from 128 (14B) - maintains 1:2 ratio
    lora_dropout=0.05,
    bias="none",
    task_type="CAUSAL_LM",
